...
<body>
  <video id='vid1' src='' class='video-js vjs-default-skin' muted='muted' autoplay='autoplay' controls preload='auto' width='640' height='360'>
  </video>
  ...
  videojs('vid1', { 
    ...
    setTimeout(function() {
      player.src({ src: 'https://www.youtube.com/watch?v=y6Sxv-sUYtM', type: 'video/youtube' });
    }, 10000);
  });
  </script>
</body>
